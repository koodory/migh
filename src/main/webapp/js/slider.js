...
(function ($, undefined) {
    ...
    var defaults = {
        ...
        pager: true,
        gallery: false,
        thumbWidth: ($(document).width() - 40)/4, //thumnail 가로
        thumbMargin: 3, //thumnail 마진
        thumbHeight: 60,
                ...
                refresh.createPager = function () {
                    ...
                    for (i = 0; i < maxSlide; i++) {
                        ...
                        if (settings.gallery === true) {
                            pagers += '<li style="float:left;width:' + settings.thumbWidth + 'px;margin-right:'
                            + settings.thumbMargin + 'px"><a href="javascript:void(0)">'
                            + '<img src="' + thumb + '" style="height:' 
                            + settings.thumbHeight + 'px; width:'
                            + settings.thumbWidth +  'px;"/></a></li>';
                        } else {
